...
class DeviceNotConfiguredScreen : AppCompatActivity(), View.OnClickListener {
    private lateinit var noDeviceConfiguredLayout: LinearLayout
    private lateinit var noDeviceFoundLayout: RelativeLayout
    private lateinit var noInternetFoundLayout: LinearLayout
    private lateinit var noServerFoundLayout: RelativeLayout
    private lateinit var noUserConfiguredLayout: LinearLayout
    private lateinit var deactivatedLayout: LinearLayout
